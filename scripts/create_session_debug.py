"""Attempt login and print full traceback to help diagnose KeyError during L.login."""
import os
import sys
import logging
import traceback
...
log = logging.getLogger('create_session_debug')
...
try:
    ...
    try:
        print('\nAttempting profile fetch for diagnostic...')
